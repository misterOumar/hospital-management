                        ...
                        children: <Widget>[
                          ...
                          Align(
                            ...
                            child: IconButton(
                              onPressed: () {
                                setState(() {
                                  headerListBool[indexListView] = !headerListBool[indexListView];
                                });
                              },
                          ...
                          child: Row(
                            ...
                            children: [
                              Container(
                                  ...
                                  child:  Column(
                                  children: listController[headerValue[indexListView]]!.entries.map((secondKey) {
                                    return Container(
                                      //color: Colors.black.withOpacity(0.5),
                              ...
                              if (headerValue[indexListView] == "Informations Patient")
                              Padding(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          decoration:  BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                              fit: BoxFit.cover,
                                              image: AssetImage(""/* "assets/images/client_img.png" */))
                                          ),
                                        )
                                      ],
                                    )),
...
class CustomTextField extends StatefulWidget {
  const CustomTextField({Key? key, required this.controller, required this.label, required this.inputType})
      : super(key: key);
