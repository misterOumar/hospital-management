                                ...
                                child: DataTable(
                                  ...
                                  columns: List.generate(
                                    ...
                                    (indexDataColumn) {
                                      return DataColumn(
                                        label: Container(
                                          //color: indexDataColumn == 0 ? Colors.amber : Colors.white,
                                          //width: indexDataColumn == 0 ? double.parse("${MediaQuery.of(context).size.width / identifiants.length}") : 120,
                                          width: 120,
                          ...
                          return InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: UnderlineTabIndicator(
                                  borderSide: BorderSide(width: 1, color: Color.fromARGB(255, 238, 238, 238))),
