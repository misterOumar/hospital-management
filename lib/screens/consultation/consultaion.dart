...
class _ConsultationState extends State<Consultation> with TickerProviderStateMixin {
  ...
  List<String> validationActionList = [
    'Annuler',
    'Valider',
    'Imprimer',
  ];

  List<Color> ValidationActionColor = [
    Colors.redAccent,
    Colors.green,
                                                                                ...
                                                                                return Padding(
                                                                                  ...
                                                                                  child: Container(
                                                                                    child: Column(
                                                                                      ...
                                                                                      children: [
                                                                                        Padding(
                                                                                          padding: const EdgeInsets.only(top: 6, bottom: 10, left: 5),
                                                                                    ...
                                                                                    (indexValidationAction) {
                                                                                      return Flexible(
                                                                                        ...
                                                                                        child: SizedBox(
                                                                                          width: 115,
                                                                                          child: MaterialButton(
                                                                                            color: ValidationActionColor[indexValidationAction],
                                                                                            height: 55,
                                                                                            elevation: 0.0,
                                                                                            shape: RoundedRectangleBorder(
                                                                                              borderRadius: BorderRadius.all(Radius.circular(5.0)),
                                                                                            ...
                                                                                            onPressed: () {
                                                                                             switch (validationActionList[indexValidationAction]) {
                                                                                               case 'Annuler':
                                                                                                  setState(() {
                                                                                            ...
                                                                                            child: Text(validationActionList[indexValidationAction]),
                                                                                          ),
                                                                                        ),
                                                                                      );
                                                                                    },
