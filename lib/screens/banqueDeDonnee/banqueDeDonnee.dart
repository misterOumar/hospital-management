...
class BanqueDeDonnee extends StatefulWidget {
  const BanqueDeDonnee({Key? key}) : super(key: key);

  @override
  State<BanqueDeDonnee> createState() => _BanqueDeDonneeState();
}

class _BanqueDeDonneeState extends State<BanqueDeDonnee> with TickerProviderStateMixin {
