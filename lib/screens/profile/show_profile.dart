...
class _ShowProfileState extends State<ShowProfile> with TickerProviderStateMixin {
                                                          ...
                                                          child: Align(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: TextField(
                                                                ...
                                                                decoration: InputDecoration(
                                                                  contentPadding:
                                                                      (indexConstantesVitales < 2) ? EdgeInsets.only(left: 60, right: 8) : EdgeInsets.only(left: 8),
                                                                  border: InputBorder.none,
                                                                  hintText: constantesVitalesValue[indexConstantesVitales],
                                                                ),
                                                              ),
